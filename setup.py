...
setup(
    ...
    install_requires=["ginzyenc>=1.2.3", "pyzmq>=17.1.0", "PyGObject>=3.32.1", "setproctitle>=1.1.10", "peewee>=3.9.6",
                      "pandas>=0.24.2", "rarfile>=3.0", "pexpect>=4.6.0", "inotify-simple>=1.1.8", "lxml>=4.3.3",
                      "psutil>=5.6.0", "matplotlib>=3.1.1"],
